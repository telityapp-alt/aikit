...
('keuangan-pribadi','Manajer Keuangan Pribadi','Lacak pengeluaran, buat anggaran, dan analisis pola keuangan bulanan kamu secara otomatis.','Keuangan','Free','/module-covers/keuangan-pribadi.png',1)
on conflict (slug) do update set
